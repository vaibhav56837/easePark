            ...
            <div className="container">
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form className="nav ms-auto d-flex">
                  <button className="btn btn-outline-warning mx-2"><Link to="/signup" className="linkq">SignUp</Link>
                  </button>
                  <button className="btn btn-outline-warning mx-2"><Link to="/signin" className="link">LogIn.</Link>
                  </button>
                </form>
              </div>
            </div>
